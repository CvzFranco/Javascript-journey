...
tabsContainer.addEventListener('click', function (e) {
  ...
  tabsContent.forEach(t => t.clasList.remove('operations__content--active'));
...
// Sticky navagitation : Scroll Event
//Bad performance
...
const headerObserver = new IntersectionObserver(stickyNav, {
  root: null,
  threshold: 0,
  rootMargin: `${navHeight}px`, // outofwiew
});
...
const sliders = function () {
  ...
  document.addEventListener('keydown', function (e) {
    ...
    e.key === 'ArrowRight' && nextSlide(); //  court circuiting
  });
...
// console.log(h1.previousElementSibling); // Used most of thetime
// console.log(h1.nextElementSibling); //Used most of thetime
...
document.addEventListener('DOMContentLoaded', function (e) {
  console.log('HTML parsed and DOM treee built');
});
